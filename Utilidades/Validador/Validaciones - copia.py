...
from drive.MyDrive.Equipo_Agua.Issemym.codigos.Validador.descripcion_grl import decribe_df
from drive.MyDrive.Equipo_Agua.Issemym.codigos.Validador.Razones_sociales import Validador_len_rs
from drive.MyDrive.Equipo_Agua.Issemym.codigos.Validador.estandarizacion_columnas import corregir_tipo_dato
from drive.MyDrive.Equipo_Agua.Issemym.codigos.Validador.rapidfuzz import process, fuzz
...
col_verificaciones_issemym = ['Conteo_issemym','Sueldo Neto', 'Percepciones Cotizables', 'Importe de Cuota SCI','Importe Aportación SCI', 
    'Importe de Cuota SCI Voluntaria','Importe de Aportación SCI Voluntaria', 'Importe de Cuota de Salud''Importe de Aportación de Salud',
    'Importe de Cuota Solidario','Importe de Aportación Solidario', 'Importe de Retención Institucional','Importe de Retención', 
    'Importe de Cuota Extraordinaria','Importe de Aportación Extraordinaria','Importe de Aportación Gastos de Administración',
    'Importe de Aportación Prima Básica','Importe de Aportación Prima de Servicios','Importe de Aportación de Prima Por Siniestros ',
...
cols_issemym_agg:list=['CURP',"Full name","Clave ISSSEMYM","key"], dict_issemym_agg:dict={"Conteo_issemym":"count",'Sueldo Neto':sum,"Percepciones Cotizables":sum, 'Importe de Cuota SCI':sum, 
    ...
    (Paramaters)
        ...
        - nombre_issemym: Nombre de la columna que tiene el nombre completo del contribuyente
    (Returns)
